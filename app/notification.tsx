...
import { Bell, Sparkles, Search, Upload, User } from "lucide-react"
...
<footer className="fixed bottom-0 left-0 right-0 bg-card border-t border-border shadow-lg z-50">
  <div className="px-4 py-3">
    <nav className="flex items-center justify-around max-w-md mx-auto">
      <button className="flex-1 flex flex-col items-center gap-1 p-2 rounded-lg hover:bg-accent/50 transition-colors">
